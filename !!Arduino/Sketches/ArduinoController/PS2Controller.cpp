...
void PS2Controller::DoSendInput () {
    ...
    int16_t leftX  = map (ps2x.Analog (PSS_LX), 0, 255, 0, 65535);
    int16_t leftY  = map (ps2x.Analog (PSS_LY), 0, 255, 0, 65535);
    int16_t rightX = map (ps2x.Analog (PSS_RX), 0, 255, 0, 65535);
    int16_t rightY = map (ps2x.Analog (PSS_RY), 0, 255, 0, 65535);
